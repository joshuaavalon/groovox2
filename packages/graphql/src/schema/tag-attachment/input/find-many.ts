...
const type = inputObjectType({
  ...
  definition(t) {
    ...
    t.nullable.list.nullable.field("and", { type: "TagAttachmentFindManyInput" });
    t.nullable.list.nullable.field("or", { type: "TagAttachmentFindManyInput" });
    t.nullable.list.nullable.field("not", { type: "TagAttachmentFindManyInput" });
  }
});
